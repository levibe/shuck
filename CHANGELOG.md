...
- Include the `shuck` command in the download, inside Shuck.app.

## [0.1.0] - 2026-09-24

### Added

- Add ⌃⌥⌘V to paste copied terminal text without its line breaks.
- Add Shuck and Paste to the right-click Services menu.
...
[0.2.1]: https://github.com/levibe/shuck/releases/tag/v0.2.1
